...
exports.ModrinthController = void 0;
const common_1 = require("@nestjs/common");
const modrinth_service_1 = require("./modrinth.service");
let ModrinthController = class ModrinthController {
    modrinthService;
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ModrinthController.prototype, "getProject", null);
__decorate([
    (0, common_1.Get)('project/:id/versions'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Query)('gameVersion')),
    __param(2, (0, common_1.Query)('loader')),
    __metadata("design:type", Function),
...
//# sourceMappingURL=modrinth.controller.js.map